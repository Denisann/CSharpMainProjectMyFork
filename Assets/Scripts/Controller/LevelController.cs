...
namespace Controller
{
    public class LevelController : IPlayerUnitChoosingListener
    {
        ...
        private BotUnitController _botUnitController;
        ...
        public void StartLevel(int level)
        {
            ...
            _botUnitController = new BotUnitController();
        ...
        public void OnPlayersUnitChosen(UnitConfig unitConfig)
        {
            ...
            SpawnUnit(RuntimeModel.PlayerId, unitConfig, _playerUnitController);
            TryStartSimulation();
        }

        private void OnBotUnitChosen(UnitConfig unitConfig)
        {
            SpawnUnit(RuntimeModel.BotPlayerId, unitConfig, _botUnitController);
            TryStartSimulation();
        }

        private void SpawnUnit(int forPlayer, UnitConfig config, IReadOnlyUnitController coordinator)
        {
